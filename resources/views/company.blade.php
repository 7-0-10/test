    ...
    <main>
      ...
      <section>
        ...
        <p>imagesフォルダに入っていない画像（アイコン）は全てFont Awesomeの素材です。<br>
          ...
          <a href="https://fontawesome.com/v5.15/icons?d=gallery&p=2">Font Awesome アイコン一覧</a>
        </p>
        ...
        <p><strong>ループを一回で終了したい場合</strong><br>
          ...
          を、以下に変更。<br>
          <span class="look">90% {opacity: 1;}<br>
            100% {opacity: <span class="color-check">1</span>;}</span>
        </p>
        <p>続いて、<br>
          ...
          を以下に変更。<br>
          <span class="look">animation-iteration-count:<span class="color-check">1</span>;</span>
        </p>
        ...
        <p><strong>速度や枚数などの調整</strong><br>
          ...
          <a href="https://template-party.com/tips/slide_css.html">スライドショーに関する詳しい使い方はこちら。</a>
        </p>
        ...
        <p>１つ目はstyle.cssの冒頭に記載されている以下で、小さな端末向けです。<br>
          ...
          <span class="look">font-size: 14px;</span>
        </p>
